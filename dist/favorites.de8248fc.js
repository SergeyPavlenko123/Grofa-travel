...
})({"3lmD8":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "6a18d3f9de8248fc";
"use strict";
...
},{}],"2ip3Q":[function(require,module,exports) {
let favTours = JSON.parse(localStorage.getItem("favTours"));
let favBlock = document.querySelector(".favorites-block");
function showFavorite() {
    for(let i = 0; i < favTours.length; i++)favBlock.innerHTML += `
        <div class="frame">
            <div class="favorites-item" style="background-image: url(./img/slider/${favTours[i].cover})">
                <div class="favorites-item-content">
                    <button class="close-button" id="${i}"></button>
                    <div class="content-heading">${favTours[i].title}</div>
                    <p class="item-text">${favTours[i].date}</p>
                    <p class="item-text">${favTours[i].price} \u{433}\u{440}\u{43D}</p>
                    <button class="button" id=${favTours[i].id}>
                       \u{41F}\u{43E}\u{457}\u{445}\u{430}\u{43B}\u{438}
                    </button>
                </div>
            </div>
        </div>
        ...
        `;
    if (favTours.length === 0) favBlock.innerHTML = `<div><h1>\u{417}\u{430}\u{440}\u{430}\u{437} \u{442}\u{443}\u{442} \u{43D}\u{456}\u{447}\u{43E}\u{433}\u{43E} \u{43D}\u{435}\u{43C}\u{430}\u{454}</h1></div>`;
}
favBlock.addEventListener("click", function(el) {
    if (el.target.matches(".close-button")) {
        let i = el.target.id;
        favTours.splice(i, 1);
        localStorage.setItem("favTours", JSON.stringify(favTours));
        favBlock.innerHTML = "";
        if (favTours.length === 0) favBlock.innerHTML = `<div class="favorite-heading"><h1>\u{417}\u{430}\u{440}\u{430}\u{437} \u{442}\u{443}\u{442} \u{43D}\u{456}\u{447}\u{43E}\u{433}\u{43E} \u{43D}\u{435}\u{43C}\u{430}\u{454}</h1></div>`;
        showFavorite();
    }
});
favBlock.addEventListener("click", function(el) {
    if (el.target.matches(".button")) var selected = favTours.find((el)=>el.id = el);
    document.querySelector("body").innerHTML = `
        <header class="header" style="background-image:url(./img/slider/${selected.cover})">
        <div class="nav-bar">
          <div class="logo">
            <a href="../index.html">
        ...
        <div class="header-title">
          <div class="title-name">${selected.title}</div>
      ...
      <main class="main">
        <div class="container">
          <div class="heading">
              ...
              <div class="heading-title">${selected.title}</div>
            </div>
...
},{}]},["3lmD8","2ip3Q"], "2ip3Q", "parcelRequire2625")

//# sourceMappingURL=favorites.de8248fc.js.map
