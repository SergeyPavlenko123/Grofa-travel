...
})({"lkGjY":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "f86a2a8a7333a1fd";
"use strict";
...
},{}],"7xWQ6":[function(require,module,exports) {
...
function getData() {
    btns.forEach((element)=>{
        element.addEventListener("click", function(el) {
          ...
          <header class="header" style="background-image:url(./img/slider/${(0, _dataJsonDefault.default)[el.target.id].cover})">
          <div class="nav-bar">
            <div class="logo">
              <a href="../index.html">
          ...
          <div class="header-title">
            <div class="title-name">${(0, _dataJsonDefault.default)[el.target.id].title}</div>
        ...
        <main class="main">
          <div class="container">
            <div class="heading">
                ...
                <div class="heading-title">${(0, _dataJsonDefault.default)[el.target.id].title}</div>
              </div>
            <div class="description" data-aos="flip-left">
              <div class="content">
                <p class="text">
                 ${(0, _dataJsonDefault.default)[el.target.id].description}
                </p>
              </div>
              <div class="poster">
...
},{}]},["lkGjY","7xWQ6"], "7xWQ6", "parcelRequire2625")

//# sourceMappingURL=tours.7333a1fd.js.map
